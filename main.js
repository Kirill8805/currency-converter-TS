...
function loadCurrencies() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, currencies, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    currencies.forEach(function (currency) {
                        fromCurrencySelect.innerHTML += "<option value=\"".concat(currency, "\">").concat(currency, "</option>");
                        toCurrencySelect.innerHTML += "<option value=\"".concat(currency, "\">").concat(currency, "</option>");
                    });
...
function convertCurrency() {
    return __awaiter(this, void 0, void 0, function () {
        var amount, response, data, fromCurrency, toCurrency, rate, convertedAmount, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    ...
                    resultText.textContent = "".concat(amount, " ").concat(fromCurrency, " = ").concat(convertedAmount, " ").concat(toCurrency);
                    return [3 /*break*/, 5];
                case 4:
                    error_2 = _a.sent();
                    console.error("Ошибка конвертации:", error_2);
